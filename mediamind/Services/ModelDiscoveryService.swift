    ...
    func getWhisperModels(modelPath: String? = nil, forceRefresh: Bool = false) -> [String] {
        ...
        do {
            ...
            if models.isEmpty {
                let knownModels = [
                    // Base models
                    "tiny", "base", "small", "medium", "large", "large-v3", "large-v2", "turbo",
                    // 4-bit quantized models
                    "tiny-4bit", "base-4bit", "small-4bit", "medium-4bit", "large-4bit", "large-v3-4bit",
                    // 8-bit quantized models
                    "tiny-8bit", "base-8bit", "small-8bit", "medium-8bit", "large-8bit", "large-v3-8bit"
                ]
