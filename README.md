...
| 类型 | 说明 | 输出文件 |
|------|------|----------|
| 🎬 字幕生成 | 生成视频字幕文件 | subtitles.srt, subtitles_bilingual.srt |
...
从 [Releases](https://github.com/yourusername/mediamind/releases) 页面下载最新的 `.dmg` 安装包。
...
- **问题反馈**: [GitHub Issues](https://github.com/yourusername/mediamind/issues)
- **功能建议**: [GitHub Discussions](https://github.com/yourusername/mediamind/discussions)
- **文档**: [项目 Wiki](https://github.com/yourusername/mediamind/wiki)
...
**如果觉得 MediaMind 对你有帮助，请给个 ⭐️ Star 支持一下！**

Made with ❤️ by MediaMind Team
